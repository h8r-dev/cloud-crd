...
import (
	v1alpha1 "github.com/h8r-dev/cloud-crd/generated/cloud/clientset/versioned/typed/cloud/v1alpha1"
...
func (c *FakeCloudV1alpha1) Environments(namespace string) v1alpha1.EnvironmentInterface {
	return &FakeEnvironments{c, namespace}
}

func (c *FakeCloudV1alpha1) Repositories(namespace string) v1alpha1.RepositoryInterface {
