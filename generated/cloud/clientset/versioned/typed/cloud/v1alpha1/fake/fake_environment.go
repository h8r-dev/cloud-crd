...
var environmentsResource = schema.GroupVersionResource{Group: "cloud.heighliner.dev", Version: "v1alpha1", Resource: "environments"}

var environmentsKind = schema.GroupVersionKind{Group: "cloud.heighliner.dev", Version: "v1alpha1", Kind: "Environment"}
...
func (c *FakeEnvironments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(environmentsResource, c.ns, name, opts), &v1alpha1.Environment{})
