...
import (
	...
	v1alpha1 "github.com/h8r-dev/cloud-crd/api/cloud/v1alpha1"
	"github.com/h8r-dev/cloud-crd/generated/cloud/clientset/versioned/scheme"
...
// CloudV1alpha1Client is used to interact with features provided by the cloud.heighliner.dev group.
...
func (c *CloudV1alpha1Client) Environments(namespace string) EnvironmentInterface {
	return newEnvironments(c, namespace)
}

func (c *CloudV1alpha1Client) Repositories(namespace string) RepositoryInterface {
...
// NewForConfigAndClient creates a new CloudV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CloudV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
