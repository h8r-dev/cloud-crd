...
import (
	...
	scheme "github.com/h8r-dev/cloud-crd/generated/cloud/clientset/versioned/scheme"
...
func newRepositories(c *CloudV1alpha1Client, namespace string) *repositories {
	return &repositories{
		client: c.RESTClient(),
		ns:     namespace,
	}
